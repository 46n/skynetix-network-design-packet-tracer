...
![KL Floor Plan](diagrams/kl-floor-plan-labeled.png)

### Detailed KL Floor Plan

![Detailed KL Floor Plan](diagrams/kl-floor-plan-detailed.png)

### KL Network Cabling Layout

![KL Network Cabling Layout](diagrams/kl-network-cabling-layout.png)

### KL Wireless Coverage Layout

![KL Wireless Coverage Layout](diagrams/kl-wireless-coverage-layout.png)

### VLSM Table

![VLSM Table](diagrams/vlsm-table.png)

### IP Addressing Table

![IP Addressing Table](diagrams/ip-addressing-table.png)

## Packet Tracer Screenshots

### Full Multi-Branch Network Overview

![Full Multi-Branch Network Overview](screenshots/all-branches-topology.png)

### Kuala Lumpur Branch Topology

![Kuala Lumpur Branch Topology](screenshots/kl-branch-topology.png)

### WAN Router Connections

![WAN Router Connections](screenshots/wan-routers-connection.png)
